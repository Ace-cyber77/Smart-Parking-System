...
import { LayoutDashboard, Car, Calendar, User, LogOut, Menu, X, MapPin } from "lucide-react"
...
const UserLayout = () => {
  ...
  const navigation = [
    ...
    { name: "Find Parking", href: "/dashboard/parking", icon: Car },
    { name: "My Bookings", href: "/dashboard/bookings", icon: Calendar },
    { name: "Parking Map", href: "/dashboard/map", icon: MapPin },

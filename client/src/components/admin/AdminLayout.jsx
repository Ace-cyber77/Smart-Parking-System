...
import { LayoutDashboard, Car, Calendar, Users, LogOut, Menu, X, BarChart3, MapPin } from "lucide-react"
...
const AdminLayout = () => {
  ...
  const navigation = [
    ...
    { name: "Parking Slots", href: "/admin/slots", icon: Car },
    { name: "Bookings", href: "/admin/bookings", icon: Calendar },
    { name: "Users", href: "/admin/users", icon: Users },
    { name: "Analytics", href: "/admin/analytics", icon: BarChart3 },
    { name: "Parking Map", href: "/admin/map", icon: MapPin },
  ]
        ...
        <div className="sticky top-0 z-40 flex h-16 bg-white border-b border-gray-200">
          ...
          <div className="flex flex-1 justify-between px-4 lg:px-6">
            <div className="flex flex-1 items-center">
              <h2 className="text-lg font-semibold text-gray-900">Smart Parking Management</h2>
            </div>
